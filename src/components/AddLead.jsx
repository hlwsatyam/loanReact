...
function EditCustomerDetailForm({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${backendUrl}/api/createNewLead`, {
        method: "POST",
        headers: {
  ...
  return (
    <div className="flex items-center justify-center bg-black bg-opacity-50">
      <div
        ...
        className="*: form w-full max-w-lg overflow-y-scroll rounded-lg border-2 border-blue-500 bg-blue-900/90 p-8 shadow-lg"
      >
